...
var QuestionPanel = (function (_React$Component) {
    ...
    */
			if (this.props.onSave) this.props.onSave(this.props.schema.questionPanels[this.props.schema.questionPanels.length - 1].action['default'].target);
		}
	}, {
		...
		value: function render() {
			...
			var questionSets = this.props.questionSets.map(function (questionSetMeta) {
				...
				for (var clazz in _this3.props.classes) {
					if (_this3.props.classes.hasOwnProperty(clazz) && _this3.props.classes[clazz] != null) classes[clazz] = _this3.props.classes[clazz];
				}
				//Add the classes that exist on the object
				if (classes["questionSet"] == null) classes["questionSet"] = questionSet.classes == null ? "" : questionSet.classes;else classes["questionSet"] += questionSet.classes == null ? "" : " " + questionSet.classes;
